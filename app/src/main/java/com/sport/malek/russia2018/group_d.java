 ...
 */
public class group_d extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        textView.setText(getResources().getString(R.string.group4));
        ListView listView=(ListView)v.findViewById(R.id.listTable);
        GroupD d=new GroupD();
        listView.setAdapter(d);

        return  v;    }
    class GroupD extends BaseAdapter {
        @Override
        public int getCount() {
            return 4;
        }
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            imageView.setImageDrawable(getResources().getDrawable(Team_Table_Group.group_D[i].getImgId()));
            nameImage.setText(Team_Table_Group.group_D[i].getNamef());
            return view;
        }
    }
