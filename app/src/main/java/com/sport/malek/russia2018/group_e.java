 ...
 */
public class group_e extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        textView.setText(getResources().getString(R.string.group5));
        ListView listView=(ListView)v.findViewById(R.id.listTable);
        GroupE e=new GroupE();
        listView.setAdapter(e);

        return  v;    }
    class GroupE extends BaseAdapter {
        @Override
        public int getCount() {
            return 4;
        }
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            imageView.setImageDrawable(getResources().getDrawable(Team_Table_Group.group_E[i].getImgId()));
            nameImage.setText(Team_Table_Group.group_E[i].getNamef());
            return view;
        }
    }
}
