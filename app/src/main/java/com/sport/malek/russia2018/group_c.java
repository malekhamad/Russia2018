 ...
 */
public class group_c extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        textView.setText(getResources().getString(R.string.group3));
        return  v;
    }
    class GroupC extends BaseAdapter {
        @Override
        public int getCount() {
            return 4;
        }
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            imageView.setImageDrawable(getResources().getDrawable(Team_Table_Group.group_C[i].getImgId()));
            nameImage.setText(Team_Table_Group.group_C[i].getNamef());
            return view;
        }
    }
}
