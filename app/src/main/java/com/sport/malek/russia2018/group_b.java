 ...
 */
public class group_b extends Fragment {
...
listView.setAdapter(p);
        ...
        textView.setText(getResources().getString(R.string.group2));
    ...
    class GroupB extends BaseAdapter {
        @Override
        public int getCount() {
            return 4;
        }
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            imageView.setImageDrawable(getResources().getDrawable(Team_Table_Group.group_B[i].getImgId()));
            nameImage.setText(Team_Table_Group.group_B[i].getNamef());
            return view;
        }
    }
