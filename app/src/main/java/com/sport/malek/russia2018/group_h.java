 ...
 */
public class group_h extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        textView.setText(getResources().getString(R.string.group8));
        ...
        return  v;    }
    class GroupH extends BaseAdapter {
        @Override
        public int getCount() {
            return 4;
        }
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            imageView.setImageDrawable(getResources().getDrawable(Team_Table_Group.group_H[i].getImgId()));
            nameImage.setText(Team_Table_Group.group_H[i].getNamef());
            return view;
        }
    }
}
